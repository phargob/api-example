...
public enum GlobalWidgetInfo {
    ...
    BANK_BUTTON_WITHDRAWAL_QUANTITY_1(WidgetIndices.Bank.GROUP_INDEX, WidgetIndices.Bank.BUTTON_WITHDRAWAL_QUANTITY_1_CONTAINER),
    BANK_BUTTON_WITHDRAWAL_QUANTITY_5(WidgetIndices.Bank.GROUP_INDEX, WidgetIndices.Bank.BUTTON_WITHDRAWAL_QUANTITY_5_CONTAINER),
    BANK_BUTTON_WITHDRAWAL_QUANTITY_10(WidgetIndices.Bank.GROUP_INDEX, WidgetIndices.Bank.BUTTON_WITHDRAWAL_QUANTITY_10_CONTAINER),
    BANK_BUTTON_WITHDRAWAL_QUANTITY_X(WidgetIndices.Bank.GROUP_INDEX, WidgetIndices.Bank.BUTTON_WITHDRAWAL_QUANTITY_X_CONTAINER),
    BANK_BUTTON_WITHDRAWAL_QUANTITY_ALL(WidgetIndices.Bank.GROUP_INDEX, WidgetIndices.Bank.BUTTON_WITHDRAWAL_QUANTITY_ALL_CONTAINER),
    // [BANK]
