...
//      final int[] skills = ctx.proxy.getSkillExperiences();
...
//      return ctx.proxy.getRealSkillLevel(getSkill(index));
//  }
...
//      ctx.methods.game.openTab(InterfaceTab.SKILLS);
//      ctx.methods.sleep(ctx.methods.random(50, 150));
//      return ctx.methods.interfaces.getComponent(WidgetIndices.SkillsTab.GROUP_INDEX, component)
//          .doHover();
//  }
